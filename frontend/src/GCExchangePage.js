...
const GCExchangePage = () => {
  ...
  return (
    ...
    >
      <SEO 
        title="GC Exchange Program"
        description="Join the GC Exchange for General Counsel seeking peer connections and strategic leadership development. Monthly exchanges and bi-annual forums."
      />
