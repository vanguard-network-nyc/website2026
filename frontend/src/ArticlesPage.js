  ...
  return (
    ...
    >
      <SEO 
        ...
        description="Leadership insights and articles from top executives. Explore expert perspectives on management, strategy, and organizational transformation."
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 md:px-8">
        ...
        <div className="text-center mb-12">
          <motion.h1 
            ...
            className="text-3xl md:text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#045184] to-[#00A8E1] bg-clip-text text-transparent mb-6 py-2 leading-tight"
          >
            Articles & Insights
          </motion.h1>
                  ...
                  {article.photo ? (
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML = '<div class="w-full h-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-blue-600"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg></div>';
                      }}
                    />
                  ) : (
