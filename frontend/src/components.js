...
const AdvisoryPage = () => {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
      ...
      >
        <h1 
          className="text-5xl md:text-6xl font-bold mb-8 bg-gradient-to-r from-[#045184] to-[#00A8E1] bg-clip-text text-transparent py-2 leading-tight"
        >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-[34px]">
      <div className="space-y-12">
        ...
        >
          {/* Upward Triangle Caret Indicator */}
          <div className="absolute -top-4 left-1/2 md:left-[83.33%] transform -translate-x-1/2">
            <div className="w-0 h-0 border-l-[16px] border-l-transparent border-r-[16px] border-r-transparent border-b-[16px] border-b-[#045184]"></div>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Ken Banta */}
            <div className="bg-white rounded-2xl p-6 shadow-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex flex-col">
            ...
            {/* Aileen Gonsalves */}
            <div className="bg-white rounded-2xl p-6 shadow-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
              <div className="w-40 h-40 rounded-full mx-auto mb-4 overflow-hidden shadow-md">
                <img 
              ...
              <p className="text-base mb-4 text-center font-semibold" style={{ color: '#045184' }}>Principal</p>
              <p className="text-slate-600 leading-relaxed text-sm mb-4 h-32">
