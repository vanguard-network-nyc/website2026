...
// ProgramsPageV2 - Enhanced, Interactive, Easy-to-Read Layout
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-medium">
            Discover our comprehensive suite of leadership development programs designed to accelerate your career and enhance your strategic impact.
          </p>
        </motion.div>
