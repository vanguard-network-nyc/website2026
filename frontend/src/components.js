          ...
          {[
            {
              ...
              linkedin: 'https://www.linkedin.com/in/kenbanta/'
            },
            {
              name: 'Tony Powe',
              role: 'Co-Founder & COO',
              ...
              linkedin: 'https://www.linkedin.com/in/tonypowe/'
            }
          ].map((member, index) => (
            <motion.div
              key={member.name}
        ...
        <div className="flex flex-wrap gap-8 justify-center max-w-7xl mx-auto mb-12">
          {[
            ...
            <motion.div
              ...
              className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.334rem)]"
              whileHover={{ scale: 1.02 }}
            >
              <div className="text-center mb-6">
                <motion.div
