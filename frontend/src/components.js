  ...
  const services = [
    {
      ...
      details: "<span class='font-semibold'>Organizational Transformation:</span> Catalyzing change by transforming what your people believe, the way they work, and how they behave. <a href='/advisory#organizational-transformation' class='text-blue-600 hover:text-blue-700 font-semibold'>Learn more</a><br><br><span class='font-semibold'>Strategic Counsel:</span> One-on-one coaching and confidential sounding boards for senior executives navigating complex decisions. <a href='/advisory#strategic-counsel' class='text-blue-600 hover:text-blue-700 font-semibold'>Learn more</a><br><br><span class='font-semibold'>Client & Stakeholder Engagement:</span> Leadership Dialogues that transform supplier relationships into trusted advisor roles through relevant conversations with clients and stakeholders. <a href='https://vanguard-network-1.preview.emergentagent.com/advisory#client-and-stakeholder-engagement' class='text-blue-600 hover:text-blue-700 font-semibold'>Learn more</a>",
      image: "https://images.pexels.com/photos/2977565/pexels-photo-2977565.jpeg",
      link: "/advisory"
    },
    {
