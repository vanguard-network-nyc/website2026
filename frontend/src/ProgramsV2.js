  ...
  return (
    ...
    >
                  ...
                  >
                    ...
                    <div className="p-4 md:p-8 flex flex-col flex-grow">
                      ...
                      {program.name === "GENERAL COUNSEL EXCHANGE" ? (
                        ...
                        <Link to="/programs/next-generation-general-counsel" onClick={() => window.scrollTo(0, 0)}>
                          <motion.button
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            className="w-full py-4 rounded-xl font-bold text-white bg-gradient-to-r from-[#045184] to-[#00A8E1] hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 group/btn"
      ...
      <motion.div
        ...
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 md:px-8 text-center mb-16"
      >
      ...
      <motion.div
        ...
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 md:px-8"
      >
