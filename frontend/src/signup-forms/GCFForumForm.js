...
const INTRO_MARKDOWN = `Please fill out the form below and we'll get back to you with details. Note that events are usually for Vanguard members. If you are not yet a member, we'll check eligibility and issue a temporary network membership.`;
...
const GCFForumForm = ({ event, onSuccess }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3" data-testid="gcf-forum-form" noValidate>
      ...
      <div aria-hidden="true" style={{ position: 'absolute', left: '-10000px', width: 1, height: 1, overflow: 'hidden' }}>
        <label htmlFor="gcf_website">Website (leave blank)</label>
        <input type="text" id="gcf_website" name="website" value={data.website} onChange={set('website')} tabIndex="-1" autoComplete="off" />
      </div>
