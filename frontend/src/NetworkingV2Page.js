      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-12">
            ...
            <h2 className="text-5xl font-bold text-slate-900 mb-6">Monthly Leadership Updates</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium">
              Stay informed with exclusive monthly content designed to keep you at the forefront of leadership excellence and industry insights.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {monthlyUpdates.map((update, index) => (
              <motion.div
                ...
                className={`rounded-xl p-8 bg-gradient-to-br ${update.gradient} text-white`}
              >
                <div className="text-center">
                  ...
                  {update.link ? (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className={`${update.title === "Newsroom" ? "bg-[#045184] hover:bg-[#034063]" : "bg-[#00A8E1] hover:bg-[#0090c7]"} text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 whitespace-nowrap mx-auto min-w-[220px]`}
                    >
                      {update.buttonText}
                      <ArrowRight size={16} />
                    </motion.a>
